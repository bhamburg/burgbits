...
<template>
  <nav class="w-full fixed top-0 z-10 bg-white dark:bg-zinc-800 shadow-xl transition">
    <div class="flex flex-wrap font-mono items-center justify-between mx-auto p-4">
      ...
      <button @click="isOpen = !isOpen" data-collapse-toggle="navbar-dropdown" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden focus:outline-none hover:text-emerald-800 hover:dark:text-indigo-400" aria-controls="navbar-dropdown" aria-expanded="false">
