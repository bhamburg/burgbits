        ...
        <ul @click="isOpen = false" class="flex flex-col font-medium p-4 md:p-0 mt-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
          ...
          <li class="hidden md:block">
            <NuxtLink to="https://github.com/bhamburg" title="GitHub" target="_blank">
              <svg alt="GitHub" class="w-6 h-6 text-zinc-800 dark:text-white hover:text-sky-800 dark:hover:text-indigo-300 transition" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
